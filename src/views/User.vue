...
request.get('/membershipTypes').then(res => state.membershipTypeOptions = res.data)
...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-table-column prop="startDate" label="会员卡开始时间"></el-table-column>
      <el-table-column prop="age" label="年龄"></el-table-column>
      <el-table-column prop="endDate" label="会员卡结束时间"></el-table-column>
      <el-table-column prop="gender" label="性别"></el-table-column>
      <el-table-column label="会员卡类型">
        <template #default="scope">
          <span v-if="scope.row.membershipTypeId">
            {{ state.membershipTypeOptions.find(v => v.id === scope.row.membershipTypeId) ? state.membershipTypeOptions.find(v => v.id === scope.row.membershipTypeId).name : '' }}
          </span>
        </template>
      </el-table-column>
    ...
    <el-dialog v-model="dialogFormVisible" title="User对象信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        ...
        <el-form-item prop="uid" label="用户唯一">
          <el-input v-model="state.form.uid" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="startDate" label="会员卡开始时间">
        ...
        <el-form-item prop="endDate" label="会员卡结束时间">
        ...
        <el-form-item prop="membershipTypeId" label="会员卡类型">
        ...
        <el-form-item prop="avatar" label="头像">
          <el-input v-model="state.form.avatar" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="role" label="角色">
          <el-input v-model="state.form.role" autocomplete="off"></el-input>
        </el-form-item>
